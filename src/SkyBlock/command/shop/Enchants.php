 ...
 * @deprecated
 * */
class Enchants extends BaseCommand {
    /**
    ...
    public function __construct(Main $plugin) {
        parent::__construct($plugin, 'enchants', 'Enchants shops');
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) : void {
        ...
        Main::getInstance()->getFormFunctions()->getShop()->sendEnchantMainMenu($sender);
    }
}
 ...
 * @deprecated
 * */
class ManaShop extends BaseCommand {
    /**
     * Shop constructor.
     *
     * @param Main $plugin
    ...
    public function __construct(Main $plugin) {
        parent::__construct($plugin, 'manashop', 'Mana Shop Menu', '', true, ['ms', 'manabuy']);
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) : void {
        ...
        Main::getInstance()->getFormFunctions()->getShop()->sendManaShopMenu($sender);
    }
}
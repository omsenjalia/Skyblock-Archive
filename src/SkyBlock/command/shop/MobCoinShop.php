 ...
 * @deprecated
 * */
class MobCoinShop extends BaseCommand {
    /**
     * Shop constructor.
     *
     * @param Main $plugin
    ...
    public function __construct(Main $plugin) {
        parent::__construct($plugin, 'mobcoinshop', 'Mob Coin Shop Menu', '', true, ['mcs', 'mcshop']);
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) : void {
        ...
        Main::getInstance()->getFormFunctions()->getShop()->sendMobCoinShopMenu($sender);
    }
}